...
2. 项目自评等级:(1-5) 请根据自己项目情况填写下表
   ...
   | float类型                | 5        | 4    |                                                              | z    |
   | for循环                  | 5        | 1    |                                                              | z    |
   | forin（支持数组和纯数字) | 3 | 4 |                         只实现了纯数字                         |      |
   | （\*……\*）注释的实现     | 5        | 1    |                                                              |      |
   | 按照进制创建整数         | 3        | 3实现  |                  实现16进制和8进制但未实现2进制的进制整数创建                  | z    |
   | 数据初值定义             | 4 | 1    |                   支持int i = 0;                   |      |
   | 模式匹配                 | 5        | 1    |                                                              |      |
   | 三目运算                 | 5        | 1    |                                                              | z    |
   | += 等语法糖              | 5        | 1    |                                                              | z    |
   | 自增自减（++/--)         | 5        | 1    |                                                              | z    |
   | 字符串                   | 5        | 3    |                                                              | z    |
   | 结构体                   | 5       | 4 |                         已实现结构体功能，并且支持运算                         |      |
   | switch case default      | 5        | 1    |                                                              | z    |
   | 类型检查                 | 0        |      |                         未实现改功能                         |      |
   | 变量名称检查             | 0        |      |                         未实现改功能                         |      |
   | continue,break | 3 | 4 | continue功能实现，break功能没有实现， | |
