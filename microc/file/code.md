...
./bin/Debug/net6.0/interpc.exe example/exam/ex6.c #查看运行结果
...
open ParseAndRun;;
fromFile "example/exam/ex6.c ";; #查看ex6.c语法树
run (fromFile "example/exam/ex6.c ") [];; #解释执行ex6.c
```
...
dotnet run --project microc.fsproj example/exam/ex6.c  #查看运行结果
.\machine.exe -trace example/exam/ex6.out 0 #追踪查看运行栈
dotnet fsi #启动fsi
				#注：以下代码在终端的fsi中运行
#r "nuget: FsLexYacc";;
...
compileToFile (fromFile "example/exam/ex6.c") "ex6";; #观察变量在环境上的分配
```
