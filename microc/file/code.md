...
open ParseAndRun;;
fromFile "ycl_example/ex6.c";; #查看preinc.c语法树
run (fromFile "ycl_example/ex6.c") [];; #解释执行preinc.c
```
...
dotnet run --project microc.fsproj ycl_example/ex6.c #查看运行结果
.\machine.exe -trace ycl_example/ex6.out 0 #追踪查看运行栈
dotnet fsi #启动fsi
				#注：以下代码在终端的fsi中运行
#r "nuget: FsLexYacc";;
...
compileToFile (fromFile "ycl_example/preinc.c") "preinc";; #观察变量在环境上的分配
```
